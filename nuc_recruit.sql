...
Source Database       : mini_resume

Target Server Type    : MYSQL
Target Server Version : 50505
File Encoding         : 65001

Date: 2016-09-02 17:03:52
*/
...
CREATE TABLE `company` (
  ...
  PRIMARY KEY (`cid`),
  UNIQUE KEY `account` (`mail`) USING BTREE
...
CREATE TABLE `companyinfo` (
  ...
  `companyinstruction` varchar(400) DEFAULT NULL,
  `logo` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`ciid`),
  KEY `sys_ci_id_to_c_id` (`ciid`) USING BTREE,
...
CREATE TABLE `position` (
  ...
  `salary` char(1) DEFAULT NULL,
  `eduRequest` char(1) DEFAULT NULL,
  ...
  PRIMARY KEY (`pid`),
  KEY `sys_pid_to_c_id` (`pid`) USING BTREE,
  KEY `position_ibfk_1` (`cid`) USING BTREE,
...
CREATE TABLE `position_resume` (
  ...
  KEY `pr_pid_to_c_id` (`pid`) USING BTREE,
  KEY `pr_rid_to_u_id` (`uid`) USING BTREE,
...
INSERT INTO `position_resume` VALUES ('00000029', '00000018', '2016-09-02', 'w');
INSERT INTO `position_resume` VALUES ('00000001', '00000018', '2016-09-02', 'w');
...
CREATE TABLE `resume` (
  ...
  `sex` char(2) NOT NULL COMMENT '0-男 \r\n1-女\r\n 2-其他',
  `nativePlace` varchar(10) NOT NULL,
  `birthday` date NOT NULL,
  `education` char(4) NOT NULL,
  `workYear` char(4) NOT NULL,
  `phone` char(16) NOT NULL,
  `idCard` char(18) NOT NULL,
  `mail` varchar(30) NOT NULL,
  `city` varchar(15) NOT NULL,
  `personPic` varchar(100) DEFAULT NULL,
  `introduction` varchar(400) NOT NULL,
  `positionApplied` varchar(30) DEFAULT NULL,
  `exceptedCity` varchar(10) DEFAULT NULL,
  `exceptedSalary` double(10,2) DEFAULT NULL,
  `postscript` varchar(400) DEFAULT NULL,
  KEY `uid` (`uid`) USING BTREE,
...
-- Records of resume
-- ----------------------------
INSERT INTO `resume` VALUES ('00000003', '詹三', '男', '广州', '1991-08-26', '3', '3', '13923039420', '441542455632326532', '601647957@qq.com', '天津', '28b47b50-bf3f-472d-a563-e8268f8802e4.png', '我就是我颜色不一样的烟火', '测试工程师', '天津', '8965.00', '我就是我颜色不一样的烟火');
INSERT INTO `resume` VALUES ('00000002', '张违', '男', '广州', '1991-08-26', '4', '2', '13923039420', '441542455632326532', '601647957@qq.com', '广州', '28b47b50-bf3f-472d-a563-e8268f8802e4.png', '我就是我颜色不一样的烟火', 'java工程师', '广州', '8965.00', '我就是我颜色不一样的烟火');
INSERT INTO `resume` VALUES ('00000004', '铝管', '男', '广州', '1986-09-01', '2', '2', '13923039420', '441542455632326532', '601647957@qq.com', '广州', '28b47b50-bf3f-472d-a563-e8268f8802e4.png', '我就是我颜色不一样的烟火', 'java工程师', '广州', '8965.00', '我就是我颜色不一样的烟火');
INSERT INTO `resume` VALUES ('00000005', '温地', '女', '广州', '1991-08-26', '2', '4', '13923039420', '441542455632326532', '601647957@qq.com', '上海', '28b47b50-bf3f-472d-a563-e8268f8802e4.png', '我就是我颜色不一样的烟火', '前端工程师', '上海', '8965.00', '我就是我颜色不一样的烟火');
INSERT INTO `resume` VALUES ('00000006', '张小', '女', '广州', '1991-08-14', '2', '2', '13923039420', '441542455632326532', '601647957@qq.com', '广州', '28b47b50-bf3f-472d-a563-e8268f8802e4.png', '我就是我颜色不一样的烟火', 'java工程师', '广州', '8965.00', '我就是我颜色不一样的烟火');
INSERT INTO `resume` VALUES ('00000007', '张凡', '男', '广州', '1991-08-26', '2', '5', '13923039420', '441542455632326532', '601647957@qq.com', '广州', '28b47b50-bf3f-472d-a563-e8268f8802e4.png', '我就是我颜色不一样的烟火', '前端工程师', '广州', '8965.00', '我就是我颜色不一样的烟火');
INSERT INTO `resume` VALUES ('00000008', '赵高', '男', '广州', '1991-08-26', '1', '2', '13923039420', '441542455632326532', '601647957@qq.com', '深圳', '28b47b50-bf3f-472d-a563-e8268f8802e4.png', '我就是我颜色不一样的烟火', '前端工程师', '深圳', '8965.00', '我就是我颜色不一样的烟火');
INSERT INTO `resume` VALUES ('00000009', '乔峰', '男', '广州', '1991-08-26', '2', '2', '13923039420', '441542455632326532', '601647957@qq.com', '广州', '28b47b50-bf3f-472d-a563-e8268f8802e4.png', '我就是我颜色不一样的烟火', 'java工程师', '广州', '8965.00', '我就是我颜色不一样的烟火');
INSERT INTO `resume` VALUES ('00000010', '碧瑶', '女', '广州', '1991-08-26', '2', '3', '13923039420', '441542455632326532', '601647957@qq.com', '梅州', '28b47b50-bf3f-472d-a563-e8268f8802e4.png', '我就是我颜色不一样的烟火', '前端工程师', '梅州', '8965.00', '我就是我颜色不一样的烟火');
INSERT INTO `resume` VALUES ('00000011', '雪琪', '女', '广州', '1991-08-26', '4', '1', '13923039420', '441542455632326532', '601647957@qq.com', '广州', '28b47b50-bf3f-472d-a563-e8268f8802e4.png', '我就是我颜色不一样的烟火', 'java工程师', '广州', '8965.00', '我就是我颜色不一样的烟火');
INSERT INTO `resume` VALUES ('00000012', '叶帆', '男', '广州', '1991-08-26', '3', '1', '13923039420', '441542455632326532', '601647957@qq.com', '广州', '28b47b50-bf3f-472d-a563-e8268f8802e4.png', '我就是我颜色不一样的烟火', 'php工程师', '广州', '8965.00', '我就是我颜色不一样的烟火');
INSERT INTO `resume` VALUES ('00000013', '刘迪', '女', '广州', '1991-08-26', '2', '3', '13923039420', '441542455632326532', '601647957@qq.com', '天津', '28b47b50-bf3f-472d-a563-e8268f8802e4.png', '我就是我颜色不一样的烟火', 'java工程师', '天津', '8965.00', '我就是我颜色不一样的烟火');
INSERT INTO `resume` VALUES ('00000014', '刘德法', '男', '广州', '1991-08-26', '3', '4', '13923039420', '441542455632326532', '601647957@qq.com', '广州', '28b47b50-bf3f-472d-a563-e8268f8802e4.png', '我就是我颜色不一样的烟火', 'php工程师', '广州', '8965.00', '我就是我颜色不一样的烟火');
INSERT INTO `resume` VALUES ('00000015', '张从', '女', '广州', '1991-08-26', '1', '2', '13923039420', '441542455632326532', '601647957@qq.com', '北京', '28b47b50-bf3f-472d-a563-e8268f8802e4.png', '我就是我颜色不一样的烟火', 'java工程师', '北京', '8965.00', '我就是我颜色不一样的烟火');
INSERT INTO `resume` VALUES ('00000016', '张具', '男', '广州', '1991-08-26', '4', '3', '13923039420', '441542455632326532', '601647957@qq.com', '广州', '28b47b50-bf3f-472d-a563-e8268f8802e4.png', '我就是我颜色不一样的烟火', 'php工程师', '广州', '8965.00', '我就是我颜色不一样的烟火');
INSERT INTO `resume` VALUES ('00000001', '张小凡', '男', '广州', '1991-08-26', '4', '1', '13923039420', '441542455632326532', '601647957@qq.com', '广州', '28b47b50-bf3f-472d-a563-e8268f8802e4.png', '我就是我颜色不一样的烟火', '厨师', '广州', '8965.00', '我就是我颜色不一样的烟火');
INSERT INTO `resume` VALUES ('00000017', '习近平', '男', '北京', '1974-06-06', '2', '3', '13515151515', '545646456546', '60164795467@qq.com', '哈尔滨', '28b47b50-bf3f-472d-a563-e8268f8802e4.png', '我是主席，我怕谁', '主席', '北京', '546.00', '色不一样的烟火');
INSERT INTO `resume` VALUES ('00000018', '邓小平', '男', '北京', '2016-09-12', '2', '3', '13515151515', '545646456546', '60164795467@qq.com', '哈尔滨', 'fec563bf-6148-4749-9403-5f86e8d694d3.jpg', '我就是我颜色不一样的烟火', 'php工程师', '北京', '4534.00', '色不一样的烟火');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('00000001', '123', '123', '3', '1233', '123', '2016-08-01');
INSERT INTO `user` VALUES ('00000002', '123', '123', '3', '1234', '123', '2016-08-01');
INSERT INTO `user` VALUES ('00000003', '123', '123', '3', '1235', '123', '2016-08-01');
INSERT INTO `user` VALUES ('00000004', '123', '123', '3', '1236', '123', '2016-08-01');
INSERT INTO `user` VALUES ('00000005', '123', '123', '3', '1237', '123', '2016-08-01');
INSERT INTO `user` VALUES ('00000006', '123', '123', '3', '1238', '123', '2016-08-01');
INSERT INTO `user` VALUES ('00000007', '123', '123', '3', '1239', '123', '2016-08-01');
INSERT INTO `user` VALUES ('00000008', '123', '123', '3', '12310', '123', '2016-08-01');
INSERT INTO `user` VALUES ('00000009', '123', '123', '3', '12311', '123', '2016-08-01');
INSERT INTO `user` VALUES ('00000010', '123', '123', '3', '12312', '123', '2016-08-01');
INSERT INTO `user` VALUES ('00000011', '123', '123', '3', '12313', '123', '2016-08-01');
INSERT INTO `user` VALUES ('00000012', '123', '123', '3', '12314', '123', '2016-08-01');
INSERT INTO `user` VALUES ('00000013', '123', '123', '3', '12315', '123', '2016-08-01');
INSERT INTO `user` VALUES ('00000014', '123', '123', '3', '12316', '123', '2016-08-01');
INSERT INTO `user` VALUES ('00000015', '123', '123', '3', '12317', '123', '2016-08-01');
INSERT INTO `user` VALUES ('00000016', '123', '123', '3', '12318', '123', '2016-08-01');
INSERT INTO `user` VALUES ('00000017', '123', '123', '3', '12319', '123', '2016-08-01');
INSERT INTO `user` VALUES ('00000018', '123', '123456', '3', '123456@qq.com', '123', '2016-08-01');
INSERT INTO `user` VALUES ('00000028', null, '123456', '2', '601647957@qq.com', 'baa3f3f1a81c8503eb31726846b96478', '2016-09-02');
